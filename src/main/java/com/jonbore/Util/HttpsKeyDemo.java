...
public class HttpsKeyDemo {
	...
	private final static String PFX_PATHAPI = "C:/Users/bo.zhou1.XXX/Documents/api证书20190709/api_client01.p12";
    ...
    public static String sslRequestGet(String url) throws Exception {
        ...
        InputStream instream = new FileInputStream(new File(PFX_PATHAPI0));
        try {
            // 这里就指的是KeyStore库的密码
            keyStore.load(instream, PFX_PWDAPI0.toCharArray());
        } finally {
            instream.close();
        }

        SSLContext sslcontext = SSLContexts.custom().loadKeyMaterial(keyStore, PFX_PWDAPI0.toCharArray()).build();
...
//            HttpGet httpget = new HttpGet(url);
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(sslRequestGet("https://api0.XXX.com/rest/console/user/login"));
